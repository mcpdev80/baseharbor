...
## Confirmed current behavior at v0.2.0 preparation
...
> Historical note: this file preserves the v0.2.0 gate as it existed for that release. The current release audit lives at `docs/pre-release-documentation-audit.md`.
