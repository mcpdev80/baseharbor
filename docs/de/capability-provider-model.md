...
| Metrics | `metrics/v1` / OpenMetrics-kompatible HTTP-Exposition | Prometheus 3.14.0 als shared Compose-Referenzprovider | v0.4.8: Source-Contract, Policy-gesteuerte Collection, automatische Target-Registrierung und echte Scrape/Ingestion-Verifikation | VictoriaMetrics, Mimir und kompatible Backends | Die Anwendung beschreibt nur ihre Metrics-Source; Collection-Policy, Retention, Query und Storage bleiben austauschbarer Plattform-/Provider-State |
