...
11. Der Release-Workflow uebernimmt die erfolgreiche Pre-Release-Evidence und fuehrt die teure Source-/Runtime-/Demo-Matrix nicht erneut aus. Er prueft nur noch release-spezifische Punkte und veroeffentlicht Runtime-Image, GitHub Release, Artefakte und Provenance.
